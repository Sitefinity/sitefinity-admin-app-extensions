...
* [Custom components loaded in the tree](./src/tree#custom-components-loaded-in-the-tree) - This extension is used to replace a part of each item shown in the tree used throughout the AdminApp. Currently supported only for the related data functionality.
